...
// import { Badge, Clock, FileText, NotebookPen } from "lucide-react";
...
//           {[
//             { label: "Total", count: issues.length, color: "text-foreground" },
//             { label: "Pending", count: issues.filter(i => i.status === "pending").length, color: "text-status-pending" },
//             { label: "In Progress", count: issues.filter(i => i.status === "in-progress").length, color: "text-status-in-progress" },
//             { label: "Resolved", count: issues.filter(i => i.status === "resolved").length, color: "text-status-resolved" },
//           ].map((stat) => (
